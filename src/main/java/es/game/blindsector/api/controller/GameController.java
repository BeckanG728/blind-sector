...
public class GameController {
     ...
     *
     * <ul>
     *   <li>Si el turno ya fue resuelto → 200 con {@link SnapshotResponse}.</li>
     ...
     * @return 200 con SnapshotResponse o con cuerpo de espera
     */
    ...
    public ResponseEntity<?> getState(
        ...
        Optional<SnapshotResponse> snapshot = snapshotService.getSnapshot(gameId, playerId);
     ...
     *
     * <ul>
     *   <li>Si hay al menos un turno resuelto → 200 con {@link SnapshotResponse}.</li>
    ...
    public ResponseEntity<?> getLastSnapshot(
        ...
        Optional<SnapshotResponse> snapshot = snapshotService.getLastSnapshot(gameId, playerId);
